...
class VipSinglePaymentChoseEmployeesPage:
    ...
    def click11(self):
        return self.bp.find_xpath("(//button[@type='button'])[8]").click()
    ...
    def click14(self):
        return self.bp.find_xpath("//div[13]/div/span/form/div[2]/div/div/label").click()
    ...
    def click17(self):
        return self.bp.find_xpath("//div[15]/div/span/form/div[2]/div/div/label[7]").click()
